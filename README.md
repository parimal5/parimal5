<div align="center">
  <h1>Hi 👋, I'm Parimal</h1>
  <h3>On a mission to automate all the boring stuff 💻⚙️</h3>
</div>


- 🚀 What I do: **Automate things so humans don’t have to**
- 📦 Obsessed with **Containers, clusters, and clean CI/CD**
- 🧰 Tools I vibe with: **Anything that has --help and doesn't fight back**
- 🌩️ Cloud comfort zone **Mostly AWS, occasionally cheating with Azure & GCP**
- 👨‍🎓 Certified **Yes (AWS), but I still Google half the stuff**
- 💻 Code lives here. **You’re already in the neighborhood 👀**
- 🧠 Brain’s favorite snacks **Weird infra problems and overthinking YAML**
- 💬 Nerd talk topics **Infra as code, pipelines, monitoring, and random DevOps chaos**
- 📫 Want to talk DevOps, clouds, or memes? Hit me up on [LinkedIn](https://www.linkedin.com/in/parimalmeshram/) or fire an email to 📡 parimalmeshram15@gmail.com
- ⚡ Fun fact **I debug life problems like I debug scripts — trial, error, coffee**
---
...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=parimal5&layout=compact&theme=radical)
